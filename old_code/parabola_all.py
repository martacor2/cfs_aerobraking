...
for folder in sorted(os.listdir(direct)):
    ...
    a_tot.append([a_array[3],a_array[4],a_array[0],a_array[1],a_array[2]])
    b_tot.append([b_array[3],b_array[4],b_array[0],b_array[1],b_array[2]])
    c_tot.append([c_array[3],c_array[4],c_array[0],c_array[1],c_array[2]])
...
labels = [7000, 9000, 11000, 13000 ,15000, 17000 , 19000 , 21000 , 23000 , 25000 , 27000]
...
labels = [5000,7000, 9000, 11000, 13000 ,15000, 17000 , 19000 , 21000 , 23000 , 25000 , 27000]
