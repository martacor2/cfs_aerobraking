...
energy_diff90, energy_diff95, energy_diff100, energy_diff105, energy_diff110 = array_conversion(np.divide(energy_diff,1000))
...
plt.figure("a_coeff")
plt.scatter(energy_diff90, a_coeff90, color='green', marker='o', label = '$h_p = 90$ km')   
plt.scatter(energy_diff95, a_coeff95, color='red', marker='o', label = '$h_p = 95$ km')   
plt.scatter(energy_diff100, a_coeff100, color='blue', marker='o',  label = '$h_p = 100$ km')   
plt.scatter(energy_diff105, a_coeff105, color='orange', marker='o', label = '$h_p = 105$ km')   
plt.scatter(energy_diff110, a_coeff110, color='purple', marker='o',  label = '$h_p = 110$ km')   
# plt.scatter(y0, a_coeff, color='blue', marker='o')    
plt.legend();plt.grid()
plt.xlabel("Energy dissipated (kJ)")
plt.ylabel("$a$")
