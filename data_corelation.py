...
plt.figure("a_coeff")
plt.scatter(drag_int_no_v90[1:], a_coeff90[1:], color='green', marker='o', label = '$h_p = 90$ km')   
plt.scatter(drag_int_no_v95[1:], a_coeff95[1:], color='red', marker='o', label = '$h_p = 95$ km')   
plt.scatter(drag_int_no_v100[1:], a_coeff100[1:], color='blue', marker='o',  label = '$h_p = 100$ km')   
plt.scatter(drag_int_no_v105[1:], a_coeff105[1:], color='orange', marker='o', label = '$h_p = 105$ km')   
plt.scatter(drag_int_no_v110[1:], a_coeff110[1:], color='purple', marker='o',  label = '$h_p = 110$ km')   
# plt.scatter(y0, a_coeff, color='blue', marker='o')    
plt.legend();plt.grid()
plt.xlabel("Integral of Drag w/o velocity ")
plt.ylabel("$a$")
fig_acoeff.savefig("all_sims_figures/a_coeff_drag_wo_velocity_no_5000.png")
